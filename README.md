...
## Доработка 1. Принцип сопоставления кодов ОКВЭД с телефонным номером
В первой версии приложения коды и телефонный номер сопоставлялись посимвольно. Таким образом искалась максимальная длина
полностью совпадающих постфиксов. Но сегодня я получил указание, что этот принцип неверен. Из чего я сделал вывод, что нужно
искать число совпадающих цифр, расположенных на соответствующих позициях с конца (совпадения не обязательно должны идти подряд). Я обновил соответствующую функцию
`_compare_code_with_phone()` согласно этому указанию.

#### <div align="right">23 декабря 2025 23:35</div>

## Доработка 2. Поддержка префиксных нулей в телефонном номере
Добавил в нормализацию номера удаление префиксных нулей из исходного номера.

#### <div align="right">24 декабря 2025 00:01</div>